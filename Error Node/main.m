...
for runs=1:RUNS
    ...
    for circulation_var=for_begin:for_gap:for_end
        ...
        Node_Error_NUM_Percent=circulation_var; %%%%%%%%%%%%%%%%%%%节点量测信息出错的百分比
        ...
        for sequence=1:Sequence_Number
            ...
            for i=fault_node_estimated
                ...
                %提升的方法使用距离进行加权
                node_promote_weight(i)= node_promote_weight(i)+exp(-0.72/(distance_multi+0.068));
                node_promote_weight(i);
                node_basic_weight(i)=node_basic_weight(i)+1;
            end
        end
        ...
        Error_Node;
        promote_method=calculate_error_node(Node_Number,node_promote_weight,Detection_Ratio);
        basic_method=calculate_error_node(Node_Number,node_basic_weight,Detection_Ratio);
